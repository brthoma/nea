...
namespace nea
{
    internal interface IClassifierEnsemble
    {
    ...
    public class MajVoting : IClassifierEnsemble
    {
    ...
    public class ProportionalVoting : IClassifierEnsemble
    {
        private double[] weights;

        public ProportionalVoting(string[] classifiers)
        {
            weights = new double[classifiers.Length];
            for (int i = 0; i < classifiers.Length; i++)
            {
                weights[i] = UI.GetDoubleInput($"Classifier: {classifiers[i]}\n    Enter weight: ");
            }
        }

        public ProportionalVoting(double[] weights)
        {
    ...
    public class AdaBoost : IClassifierEnsemble
    {
